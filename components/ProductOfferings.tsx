...
const cards = [
  {
    ...
    desc: "Show a list of your business services and provide online quotes, so customers get the info they need to choose you.",
    bgColor: "bg-[#fef7e0]", 
    type: 'services'
  },
  {
    title: "Be found for what you sell",
    desc: "Be found by automatically listing your in-store products for free, right from your Business Profile.",
    bgColor: "bg-[#e6f4ea]", 
    type: 'products'
  },
  {
    title: "Accept food orders and more",
    desc: "Take orders for delivery and pickup and let customers make reservations. Even add your menu, so people can discover your best dishes.",
    bgColor: "bg-[#e8f0fe]", 
    type: 'food'
  }
];
      ...
      <div className="mx-[28px] md:mx-[40px] lg:mx-[72px] xl:mx-auto max-w-[1456px]">
        <div className="grid grid-cols-4 md:grid-cols-12 gap-x-[28px] md:gap-x-[40px] lg:gap-x-[48px] xl:gap-x-[64px]">
          ...
          <div className="col-span-4 md:col-span-8 lg:col-span-4 self-start lg:sticky lg:top-[calc(50vh-144px)] mb-12 lg:mb-0">
            <h2 className="text-[#3c4043] text-[48px] font-normal leading-[1.16667] tracking-[-.5px] font-['Product_Sans'] mb-4 lg:text-left text-center">
              <span className="font-medium">Show what you offer, from products to services</span>
            </h2>
            <div className="pt-4 lg:pt-6">
              <span className="text-[#3c4043] text-[16px] leading-[1.5] font-normal tracking-[.1px] font-['Roboto'] lg:text-left text-center block">
              ...
              >
                <div className={`relative bg-white rounded-[24px] p-[18px_18px_32px] flex flex-col min-h-[500px] border-2 transition-all duration-500 ${
                  ...
                  <div className="flex flex-col flex-1 px-0 lg:px-[22px] mt-6">
                    <h3 className="text-[#202124] text-[36px] font-normal leading-[1.22222] tracking-[-.25px] font-['Product_Sans'] mb-4">
                    ...
                    <div className="mt-auto pt-[15px] px-[11px]">
                      <a href="#" className="text-[#1a73e8] font-medium text-[16px] h-[48px] px-[13px] rounded-full inline-flex items-center justify-center transition-colors hover:bg-[#1a73e80a] font-['Product_Sans']">
                        Learn more
                      </a>
                    </div>
                  </div>
